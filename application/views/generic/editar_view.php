...
<fieldset>
  ...
  ?>
    <div class="form-actions">
      ...
      <button class="btn btn-success aplicar" type="button" caminho="<?php echo base_admin("controle/salvar_update/".$this->uri->segment(4))?>"><i class="icon-star"></i>&nbsp;Aplicar</button>
